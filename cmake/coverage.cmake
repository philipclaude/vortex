...
if(BUILD_TYPE AND BUILD_TYPE MATCHES "COVERAGE")
 ...
 if(APPLE)
  ...
  set(LCOV_FLAGS --capture -q --gcov-tool ${GCOV} --no-external --base-directory ${CMAKE_SOURCE_DIR} --directory . --output-file ${COVERAGE_INFO} --ignore mismatch --ignore-errors inconsistent)
